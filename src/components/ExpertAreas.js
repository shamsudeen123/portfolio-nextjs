          ...
          <div className="container">
            <div className="informations_inner">
              <div className="left">
                ...
                <div className="text">
                  <p>
                  With a deep understanding of React.js, I specialize in crafting dynamic and interactive user interfaces. Proficient in leveraging React's component-based architecture and state management for seamless front-end development.
                  </p>
                  <p>
