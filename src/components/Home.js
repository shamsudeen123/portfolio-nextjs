    ...
    <div className="orido_tm_hero orido_tm_section" id="home">
      <div className="container">
        ...
        <div className="orido_tm_follow">
          ...
          <ul>
            <li>
              <a href="https://www.linkedin.com/in/samsudeen-sm-9b73a7183/" target="_blank">
                <img className="svg" src="img/svg/social/linkedin.svg" alt="" />
              </a>
            </li>
            <li>
              <a href="https://github.com/shamsudeen123" target="_blank">
                <img className="svg" src="img/svg/social/github.svg" alt="" />
              </a>
            </li>
            <li>
              <a href="https://www.instagram.com/c.h.a.n.c.h.u/" target="_blank">
                <img
                  className="svg"
